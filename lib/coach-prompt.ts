// Generated from content/prompts/polyglot-coach.system.md (npm run gen). Do not edit.
export const SYSTEM_PROMPT = `# POLYGLOT COACH — core system prompt (shared by planner, drill author, examiner, grader)
